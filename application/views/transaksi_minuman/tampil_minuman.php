<div class="col-lg-5 mt-3 mb-5">
    <div class="card-header"> <strong><i class="fas fa-coffee"></i> Pilih Minuman </strong> </div>
    <div class="row">
        <!-- Button trigger modal -->
        <?php foreach ($minuman as $m) : ?>
            <div class="card mt-4 ml-3 hover" style="width: 10rem; cursor:pointer;" onclick="pilih(<?= $m['id'] ?>)">
                <img src="<?= base_url('assets/images_upload/minuman/') . $m['gambar']; ?>" class="card-img-top">
                <div class="card-body ">
